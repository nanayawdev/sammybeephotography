      ...
      <div className="max-w-7xl mx-auto px-8 py-24 pt-32">
        ...
        <div className="prose prose-lg max-w-4xl">
          ...
          <p className="text-gray-600">
            We understand that every moment is unique, and we strive to capture the authentic emotions and connections that make these moments special. Let us help you preserve your memories in the most beautiful way possible.
          </p>
        </div>
      </div>
    </main>
