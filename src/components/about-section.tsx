          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tracking-tight leading-tight">
                THE ESSENCE OF
                <br />
                <span className="text-gray-400 dark:text-white">PHOTOGRAPHY</span>
              </h2>
            </div>
            ...
            <button 
              className="group inline-flex items-center bg-black dark:bg-white text-white dark:text-black rounded-none px-8 py-4 text-sm font-medium 
